...
[Open Data Buffalo](https://data.buffalony.gov) is a great resource and initiative to make datasets open and available to the public. My goal here is to identify available datasets in order to do a interesting, fun, and possible useful analysis or web application in the future. Let's get started!
...
Eureka! So seems like I can use this package to start reading in and playing with full datasets. I can also use the API to make smaller requests based on filters, too.
